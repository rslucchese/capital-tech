            ...
            <Router history={history}>
                <div>
                    ...
                    <Switch>
                        ...
                        <Route path="/contatos" component={CourseListContainer} />
                        <Route exact path="/contato" component={AddOrEditCourseContainer} />
                        <Route path="/contato/:id" component={AddOrEditCourseContainer} />
