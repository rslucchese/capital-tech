...
export class CourseListContainer extends React.Component {
    ...
    handleEditCourse() {
        ...
        if (selectedCourseId) {
            ...
            this.props.history.push(`/contato/${selectedCourseId}`);
        }
    }
                ...
                <div className="row mt-3">
                    <div className="col">
                        <div className="btn-group" role="group">
                            ...
                            >
                                <i className="fa fa-plus" aria-hidden="true"/> Criar
                            </button>
                            ...
                            >
                                <i className="fa fa-trash-o" aria-hidden="true" onClick={this.handleDelete}/> Deletar
                            </button>
                        </div>
                    </div>
                </div>
