            ...
            <div className="container">
                ...
                <div className="collapse navbar-collapse" id="mainNav">
                    <div className="navbar-nav">
                        <NavLink className="nav-item nav-link" exact activeClassName="active" to="/">Intro</NavLink>
                        <NavLink className="nav-item nav-link" activeClassName="active" to="/about">Não Clique Aqui</NavLink>
                        <NavLink className="nav-item nav-link" activeClassName="active" to="/contatos" >Vamos Ao Que Interessa</NavLink>
